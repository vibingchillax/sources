...
export async function runAllSourcesForManga(
  sources: Source[],
  ops: RunAllForMangaOptions,
...
export async function runSourceForManga(
  sources: Source[],
  ops: RunForMangaOptions,
...
export async function runSourceForChapters(
  sources: Source[],
  ops: RunForChaptersOptions,
...
export async function runSourceForPages(
  sources: Source[],
  ops: RunForPagesOptions,
